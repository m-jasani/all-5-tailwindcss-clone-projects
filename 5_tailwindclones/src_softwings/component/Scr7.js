...
export default function Scr7() {
  return (
    <div>
      ...
      <p className="pb-10">Get in touch, send us an e-mail or call us</p>

      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 ">
        <div className=" bg-slate-100 w-[100%] flec justify-center md:ml-32">
          <div className="text-blue-600  ml-[40%] md:mx-56 md:my-5">
            <svg
        ...
        <div className=" bg-slate-100  flec justify-center md:ml-40">
          <div className="text-blue-600  ml-[40%] md:mx-36  md:my-5">
  ...
  <path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z" />
        ...
        <div className=" bg-slate-100  flec justify-center md:ml-10 md:mr-32">
          <div className="text-blue-600  ml-[40%] md:mx-36  md:my-5">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10">
